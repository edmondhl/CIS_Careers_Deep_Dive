...
#code to the col in gov data where it gives overall avg of tech job in states
...
#returns only the technology skills data that belong to the tech occupations in dataset. also removes any whitespace in the 15- codes
